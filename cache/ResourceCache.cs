...
namespace ChekhovsUtil.cache
{
    public sealed class ResourceCache
    {
        ...
        public void LoadTexture(string key, string assetName)
        {
        ...
        // Load and get Song
        public void LoadSong(string key, string assetName)
        {
        ...
        public void LoadSoundEffect(string key, string assetName)
        {
